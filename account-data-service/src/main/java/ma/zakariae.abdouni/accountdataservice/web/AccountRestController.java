package ma.zakariae.abdouni.accountdataservice.web;

import net.devh.boot.grpc.client.inject.GrpcClient;
import ma.zakariae.abdouni.accountdataservice.feign.CustomerRestClient;
import ma.zakariae.abdouni.accountdataservice.mapper.CustomerMapper;
...
public class AccountRestController {
    ...
    public List<Customer> listCustomers(){
        ...
        Customer[] customers = restTemplate.getForObject("http://localhost:8085/customers", Customer[].class);
        return List.of(customers);
    }
    @GetMapping("/customers/{id}")
    public Customer customerById(@PathVariable Long id){
        Customer customer = restTemplate.getForObject("http://localhost:8085/customers/" + id, Customer.class);
        return customer;
    }
    ...
    public List<Customer> soapCustomers(){
        List<ma.zakariae.abdouni.customerdataservice.web.Customer> soapCustomers = customerSoapService.customerList();
    ...
    public Customer customerByIdSoap(@PathVariable Long id){
        ma.zakariae.abdouni.customerdataservice.web.Customer soapCustomer = customerSoapService.customerById(id);
